...
\addtitle{Use Case 2}{ChangeChannelRating} 

\addfield{ID:}{2}

\addfield{Краткое описание:}{IPTV Пользователь меняет рейтинг канала}
...
\item include (ViewChannelRating)
%\item[2.1.3] Система выводит кнопку снижения рейтинга IPTV Пользователя
%\item[2.1.4] Система выводит кнопку понижения рейтинга IPTV Пользователя
\item IPTV Пользователь меняет рейтинг канала
}
