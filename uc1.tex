...
\addtitle{Use Case 1}{ViewChannelRating} 

\addfield{ID:}{1}

\addfield{Краткое описание:}{Система выводит данные о текущем рейтинге каналов}
...
\addfield{Главные актеры:}{IPTV Пользователь}

\addfield{Второстепенные актеры:}{нет}
...
\addfield{Предусловия:}{нет}
%when multiple
%\additemizedfield{Preconditions:}{} 

%Main Success Scenario: A typical, unconditional happy path scenario of success.
\addscenario{Основной поток:}{
	\item Use Case начинается, когда IPTV Пользователь вызывает менеджер управления каналами
	\item Если система содержит информацию хотя бы об одном канале, тогда
      \begin{enumerate}
        \item Для каждого канала
          \begin{enumerate}[label*=\arabic*.]
            \item Система выводит название канала
            \item Система выводит текущий рейтинг канала
          \end{enumerate}
      \end{enumerate}
    \item Иначе
      \begin{enumerate}
        \item Система сообщает IPTV Пользователю, что информации ни об одном канале не найдено
      \end{enumerate}
}

%Extensions: Alternate scenarios of success or failure.
%\addscenario{Альтернативные потоки:}{
